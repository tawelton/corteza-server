...
function types {
	...
	./build/gen-type-set --types Event --output pkg/auditlog/types.gen.go --with-primary-key=false --package auditlog
	./build/gen-type-set-test --types Event --output pkg/auditlog/types.gen_test.go --with-primary-key=false --package auditlog
